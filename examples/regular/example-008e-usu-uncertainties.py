...
propfun, prop_logpdf = postdist.generate_proposal_fun(mh_startvals, scale=0.08, rho=0.5)
...
mh_res = mh_algo(mh_startvals, postdist.logpdf, propfun, 100000,
                 ...
                 save_dir='results-008e', save_prefix='mh_res_000_', save_batchsize=100, seed=823229) 
