...
cdt = attach_endep_usu_df(dt, ['MT:1-R1:9'], [1, 7, 12.5, 17.5], [0.1]*4)
...
# import pickle
# with open('data-example-007a-mh-res.pkl', 'wb') as fout:
...
meanvec = np.mean(smpl[:, :], axis=1)
stdvec = np.std(smpl[:, :], axis=1)
meanvec[-10:]
stdvec[-10:]
