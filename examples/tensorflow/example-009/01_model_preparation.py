...
usu_df = create_endep_abs_usu_df(
        exptable, ('MT:1-R1:8', 'MT:2-R1:8', 'MT:1-R1:9', 'MT:2-R1:9',
                   'MT:3-R1:9-R2:8', 'MT:4-R1:9-R2:8',
                   'MT:4-R1:10-R2:8', 'MT:1-R1:10', 'MT:3-R1:10-R2:8', 'MT:2-R1:10'),
        (0., 1., 2., 6., 12., 14.5, 17.5), (1e-2, 1e-2, 1e-2, 1e-2, 1e-2, 1e-2, 1e-2)
)
