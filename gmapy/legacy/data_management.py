...
def init_prior():
    ...
    APR = Bunch({
        'CLAB': np.empty((35+1,1+1), dtype=object),
        ...
        'fisdata': None  # see also init_fisdata above
        })
    return APR
